...
MMdirec1 = '/Users/warmflashlab/Desktop/A_NEMASHKALO_Data_and_stuff/2_NO_QUADRANTS_goodData(esi017Cells)/Outall_files_PluriNtwInh/MEKioriginal';
chan = {'DAPI'};
filenames1 = {'FGFi(R)_C0001.tif'};
...
dir = '/Users/warmflashlab/Desktop/A_NEMASHKALO_Data_and_stuff/13_20160222-PaperFigures_DATA/CEtroubleshooting/Control_FGFinDiffexper';%'/Users/warmflashlab/Desktop/A_NEMASHKALO_Data_and_stuff/2_NO_QUADRANTS_goodData(esi017Cells)/2016-10-03-densityR/62um';%'/Volumes/data2/Anastasiia/totestClonyGrouping/torun';
%dir = '/Volumes/data2/Anastasiia/2016-04-06-Inhibitors(Bi_FGFRi)/FGFRi_extracted';
matfile = '/Users/warmflashlab/Desktop/A_NEMASHKALO_Data_and_stuff/13_20160222-PaperFigures_DATA/CEtroubleshooting/didnotwork/C_pluri_fgfindiff.mat';
chan = 'DAPI';
scale = 0.2;
N =10;
...
nms = {'C_pluri_fgfindiff'};    % ,'Lefty_R','otherMEKi_R'  dapi gfp(sox2) rfp(nanog)
nms2 = {'C_pluri_fgfindiff'};%  ,'Lefty','MEKi*'  nanog(555) peaks{}(:,8), pERK(488) peaks{}(:,6)
% nms = {'siRNAnodalNegativeC(pluri)','siRNAnodalNegativeC(pluri)regroup'};    % ,'Lefty_R','otherMEKi_R'  dapi gfp(sox2) rfp(nanog)
% nms2 = {'80','170'};%  ,'Lefty','MEKi*'  nanog(555) peaks{}(:,8), pERK(488) peaks{}(:,6)
...
usemeandapi =[];
flag1 = 1;
[mediaonly,~,~,~,~]= plotallanalysisAN(1.2,nms,nms2,dir,[],[],[10 5],[8 6],'Nanog','Dapi',0,1,dapimax,chanmax,usemeandapi,flag1);  
% h = figure(1);
...
nms = {'GFPs4cells_failedimagingJune3'};    % ,'Lefty_R','otherMEKi_R'  dapi gfp(sox2) rfp(nanog)
nms2 = {'GFPs4cells_failedimagingJune3'};%  ,'Lefty','MEKi*'  nanog(555) peaks{}(:,8), pERK(488) peaks{}(:,6)
dapimax =5000;%now used as the area thresh in colony analysis; dapimax is set to max 60000 within the generalized mean function
chanmax = 60000;
usemeandapi =[];
index1 = [6 5];
...
direc = '/Users/warmflashlab/Desktop/A_NEMASHKALO_Data_and_stuff/2_NO_QUADRANTS_goodData(esi017Cells)/2016-09-09-uCOlvsRandomCellArrangement_sameChip/area2_pattern';%'/Volumes/data2/Anastasiia/totestClonyGrouping/torun';
paramfile = '/Users/warmflashlab/Desktop/A_NEMASHKALO_Data_and_stuff/2_NO_QUADRANTS_goodData(esi017Cells)/2016-09-06-otherMEKi_uCol/totestClonyGrouping/setUserParamAN20X_uCOL.m';
run(paramfile);
