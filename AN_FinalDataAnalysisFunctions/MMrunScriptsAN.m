...
% nms = {'esi017_42hr53hr_denser(2)'};          %midcoord[11 10]  fincoord[22 22]
 ...
 %[n,t] = RunAnalysisFullChipAN(0.2,4,nms,nms2,[11 10],[21 22],[8 5],[8 6],'Sox2','Cdx2');
 % title('control according to the label');
 % [n,totalcells] = RunAnalysisFullChipAN(thresh,Nplot,nms,nms2,midcoord,fincoord,index1,index2,param1,param2)
 ...
 %nms = {'Q4_1ng42hr','Q2_10ng42hr','Q3_1ng53hr','Q1_10ng53hr'};    % from
...
ANrunOneMM('FullChip42hVolumesControl(2)_1',N,bIms,nIms,'setUserParamAN20X','DAPI');
%
%%
...
%function
 ...
 runFullTileMM('Q1_AN_(10ng_53hr)','Q1testcolchoice2.mat','setUserParamAN20X');
