...
dim2 = s1/mag; %rows, in the y direction
dim2 = round(s1/mag(2));

dim1 = s2/mag; % cols, in the x direction
dim1 = round(s2/mag(1));

for i = 1:dim1         % here need to set up correctly how the matrix will be subdevided into images (j and i ) and also code them into the name of the resulting position
    for j = 1:dim2
pos0_0 = I(1:2048,1:2048);
    end
end
