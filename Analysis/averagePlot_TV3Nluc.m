function [avgreturn,curseur]=averagePlot_TV3Nluc(cells,plotcols,pictimes,feedings,ps,mkhandle,mklegend,frameNb)
...
for ii=1:(length(cells)-1)
    ...
    framestouse=ismember(of,framestoplot) & cells(ii).fdata(:,2)'>0;% BS changed col 3 to col2 to test for frametouse (to support Nluc data)
