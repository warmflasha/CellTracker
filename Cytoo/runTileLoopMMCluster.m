...
for ii=1:nloop
    ...
    fprintf(fid,['srun matlab -nodisplay -r "addpath(genpath(''/home/aw21/CellTracker'')); parpool(''local'',' int2str(imgsperprocessor) '); runTileMMCluster(''' direc ''',''outall.mat'',' int2str(n1) ':' int2str(n2)  ',''' paramfile '''); delete(gcp); quit"']);
    fclose(fid);
