function sdata=AnalyzePlates(platenum,showfig)
...
for ii=5:8
    mat1=[direc filesep 'S' int2str(ii) '-MP-' pn];
    [mm(:,ii-4) ncells(:,ii-4)]=readPlateData(mat1);
end
...
for ii = 1:4
    ...
    nc(end+1,:)=zeros(1,25);
    subplot(2,2,ii);
    pcolor(nc); shading flat; caxis([0.9 1.3]);
end
end
