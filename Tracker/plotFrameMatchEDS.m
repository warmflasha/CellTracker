function plotFrameMatchEDS(peaks,frame, imgdir, imgfiles,usehisteq)
% 
...
name0 = [imgdir, filesep, imgfiles(frame-1).nucfile];
name1 = [imgdir, filesep, imgfiles(frame).nucfile];
  
img1=im2double(imread(name0 ));
