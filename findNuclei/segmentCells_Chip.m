function [maskC, statsN] = segmentCells_Chip(red0, gr0,B)
%
...
%     statsN = countNucCtr_Chip(red, thresh2,[],B);
    ...
    if isfield(userParam, 'gaussFilterRadiusEdge') && userParam.gaussFilterRadiusEdge ~= userParam.gaussFilterRadius
        ...
        [maskN, statsN] = edge_thresh_nuc(red, statsN, bckgnd);                                         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%lots of stuff can get cut here
