...
%
userParam.dontFilterNuc=1; % set to 1 to skip threshold filtering step
userParam.radiusMin = 23; 
userParam.radiusMax = 25;
userParam.minNucSep = 15;
if rescale < 1
...
userParam.nucAreaHi = 3600*rescale^2;  % not too big
userParam.nucSolidity = 0.50; % get rid of funny shapes
userParam.nucAspectRatio = 4.5; % not too far from circular
...
userParam.donutRadiusMax = 0*rescale;  % set to zero to skip 
