function setUserParamCCC10x(img)
%
...
userParam.removeNucNearBndry = 0;  % if nuc within radiusMax of bndry remove
userParam.radiusMin = 4; 
userParam.radiusMax = 6;
userParam.minNucSep = 10;
userParam.nucIntensityRange = 1.2;   % value depends on radiusMin/Max 
