function setUserParamCytoomTesrEDS(img)
%
...
%   Setup 4/13 for mTesR cells Expt12
...
% This variable used to collect error stats from all routines
userParam.errorStr = [];
...
userParam.verboseCountNuc = 2;  % =2 to print statistics and an image
...
% positives, increase.
%   To adjust the two nucIntensity numbers, run with verbose=2 and look at
...
userParam.nucIntensityLoc   = 8;  %20; 
...
userParam.nucAreaLo = 50*rescale^2; 
userParam.nucAreaHi = 1000*rescale^2;  % not too big
userParam.nucSolidity = 0.50; % get rid of funny shapes
userParam.nucAspectRatio = 3.0; % not too far from circular
