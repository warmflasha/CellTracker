...
================================
-run_dutchess.sh (shell script run to temporarily set environment variables and execute 
 the application)
   -to run the shell script, type
   
       ./run_dutchess.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v717, run the shell script as:
       ...
       ./run_dutchess.sh /mathworks/home/application/v717
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_dutchess.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -include when building component by clicking "Add MCR" link 
    in deploytool
-The Macintosh bundle directory structure dutchess.app 
   -this can be gathered up using the zip command 
    zip -r dutchess.zip dutchess.app
    or the tar command 
    tar -cvf dutchess.tar dutchess.app
-This readme file 
...
A. Mac systems:
   ...
   Compiler User's Guide.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_dutchess.sh 
