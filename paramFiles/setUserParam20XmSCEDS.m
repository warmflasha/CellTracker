function setUserParam10XmSCEDS(img)
%
...
userParam.verboseSegmentCells = 2;
...
userParam.minNucSep = 7;
userParam.nucIntensityRange = 2;   % value depends on radiusMin/Max 
userParam.nucIntensityLoc   = 2;    % both sould be 5
