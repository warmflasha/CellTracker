function setUserParamCCC10xBS110607_RFPsmad2(img)
%
%  adapted from setUserParamsCCC10x(img)
%
...
userParam.donutRadiusMax = 5*rescale;  % set to zero to skip 
