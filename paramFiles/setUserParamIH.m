...
userParam.gaussRadius=4;% originally named Gauss_Filter_Radius; 4 is good for 10x images;6 is ok for 20X
...
userParam.nucIntensityRange = 3;   % value depends on radiusMin/Max 
userParam.nucIntensityLoc   = 20;  % 490 for the 40*e10^3 cells per chip dataset


%Prior parameters for filtering nuclei based on size/shape, etc from AW
%(Area)
userParam.nucAreaLo =60; % measure the actual values and decide on this parameter
