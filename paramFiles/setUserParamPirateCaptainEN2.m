function setUserParamPirateCaptainEN2(img)
%
...
% filter all 512x512 sized images with this gaussian filter to give clean
% local max, and edge detection, 2 will not work
userParam.gaussFilterRadius = 2*rescale;
...
% backgndMethod = -1 presubtract background using blank image
...
userParam.verboseCountNuc = 2;  % to print statistics and an image make =2
...
userParam.radiusMin = 5; %5
userParam.radiusMax = 10;
userParam.minNucSep = 7;%6
if rescale < 1
    userParam.radiusMin = 2;% 5 
    userParam.radiusMax = 6;
    userParam.minNucSep = 5;% 3
end
...
userParam.gaussThreshExcess = 2;                                        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% key number to change, now about 19 instead of 35
userParam.gaussThreshSigma  = 2;
...
% to output
%
userParam.donutRadiusMin = 2;  % must be >=0
userParam.donutRadiusMax = 4*rescale;  % set to zero to skip 
