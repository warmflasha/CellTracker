function setUserParamSC20X_Zeeshan(img)
%
...
userParam.nobirths = 0;
userParam.verboseCellTrackerEDS = 0;
userParam.minTrajLen = 4;
userParam.mergeGap = 4;
userParam.sclDstCost = [2,4];

userParam.splineparam= 0.95;
userParam.minlength = 10;
userParam.mincyto = 1;
userParam.devthresh = 1;
